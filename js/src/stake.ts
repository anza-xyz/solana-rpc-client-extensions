import { fixCodecSize, getArrayCodec, getBytesCodec, getStructCodec, getU32Codec, getU64Codec } from '@solana/codecs';
...
export const stakeHistoryCodec = getArrayCodec(
    stakeHistoryEntryCodec, { size: getU64Codec() }
);
